#ifndef __LD_UNIAD_CUTLASS_IMPLICIT_GEMM_H__
#define __LD_UNIAD_CUTLASS_IMPLICIT_GEMM_H__
...
namespace bench {
namespace cutlass_implicit_gemm {

// template <class ProblemShape, class CtaTiler,
//           class TX, class AStride, class ASmemLayout, class TiledCopyA,
...
// void
// cuda_cutlass_implicit_gemm_kernel_v2(T * y, T * x, const T * w, int N, int H, int W, int C, 
...
template <class T>
void
launch_cutlass_implicit_gemm(T * y, T * x, const T * w, int N, int H, int W, int C, 
                            int K, int R, int S, int pad_h, int pad_w, int U, int V, int dilation_h, int dilation_w) 
{
//   using namespace cute;
...
//   cudaFuncSetAttribute(cuda_cutlass_implicit_gemm_kernel_v2<decltype(prob_shape), decltype(cta_tiler),
...
//   cuda_cutlass_implicit_gemm_kernel_v2<<<dimGrid, dimBlock, 0, stream>>>
...
template <typename T>
float cutlass_implicit_gemm(T * y, T * x, const T * w, int N, int H, int W, int C, 
                            int K, int R, int S, int pad_h, int pad_w, int U, int V, int dilation_h, int dilation_w)  {
    ...
    launch_cutlass_implicit_gemm<T>(y, x, w, N, H, W, C, K, R, S, pad_h, pad_w, U, V, dilation_h, dilation_w);
...
#endif // __LD_UNIAD_CUTLASS_IMPLICIT_GEMM_H__