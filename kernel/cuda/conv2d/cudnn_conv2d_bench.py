...
def bench_conv2d():
    ...
    manual_conv2d = load(name='manual_conv2d', 
                         ...
                         verbose=False,
                         extra_include_paths=[conda_packages_include, conda_env_include],
    ...
    used_time = manual_avg_time_function(manual_conv2d.cudnn_conv2d_nhwc_best, y, x, w, pad_h, pad_w, U, V, dilation_h, dilation_w, repeat)
    ...
    used_time = manual_avg_time_function(manual_conv2d.cudnn_frontend_conv2d, y, x, w, pad_h, pad_w, U, V, dilation_h, dilation_w, repeat)
