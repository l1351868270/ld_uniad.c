...
template<int _height, int _width, ducks::st_layout::all layout=ducks::st_layout::swizzle> using st_hf = st<half, _height, _width, layout>; // prelim tests indicate this is fastest default
